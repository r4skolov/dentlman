...
var heroslideSpeed = 1500;
var bodyStyles = window.getComputedStyle(document.body);
var fooBar = bodyStyles.getPropertyValue('--hero-slide-speed');
document.body.style.setProperty('--hero-slider-speed', heroslideSpeed + 'ms');
var swiperHero = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.hero__swiper', (_Swiper = {
  slidesPerView: 1,
  spaceBetween: 0,
  speed: 300,
  loop: true,
...
}, _defineProperty(_Swiper, "speed", heroslideSpeed), _defineProperty(_Swiper, "navigation", {
...
var swiperSpecial = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.special__swiper', {
  slidesPerView: 2,
  speed: 300,
  loop: true,
  navigation: {
...
var swiperWatched = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.watched__swiper', {
  slidesPerView: 2,
  speed: 300,
  loop: true,
  navigation: {
...
var swiperRelated = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.related__swiper', {
  slidesPerView: 2,
  speed: 300,
  loop: true,
  navigation: {
...
var swiperBrands = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.brands-swiper', {
  slidesPerView: 3.1,
  spaceBetween: 17,
  speed: 300,
  loop: true,
...
var swiperCategory = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.category-swiper', {
  slidesPerView: 'auto',
  spaceBetween: 10,
  speed: 300,
  loop: true,
...
var swiperProductNav = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".product__swiper-nav", {
  spaceBetween: 6,
  slidesPerView: 3,
  freeMode: true,
...
var swiperProduct = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".product__swiper", {
  spaceBetween: 4,
  navigation: {
...
var header = document.querySelector('.header'); // ========== фикс шапки
...
var CLASS_OVERFLOW = '_scroll-disabled';
  ...
  if (showPopupBtns.length) {
    showPopupBtns.forEach(function (opener) {
      opener.addEventListener('click', function (event) {
        ...
        var headerTwo = document.querySelector('.fixed-block');
        var Y = window.scrollY;
...
select();
var tooltip = document.querySelector('.tooltip__btn');
...
function filterOpen() {
  ...
  if (filtersMenu) {
    var closeFilters = document.querySelector(".filters__close-btn");
    var filtersButtons = document.querySelector(".filters__buttons");
...
if (window.matchMedia("(min-width: 1280px)").matches) {
  function fixedBlock() {
    var sticky = document.querySelector('.order__info');

    if (sticky) {
      var footer = document.querySelector('.order__wrapper').scrollHeight;
...
function init() {
  ...
  var mapItem = document.querySelector('.map-order');
...
function init2() {
  ...
  if (contactsMap) {
    var map = new ymaps.Map('contacs-map', {
      center: center,
      zoom: 17
    });
  }
...
function textCount() {
  var textArea = document.getElementById('order-comment');
...
var smoothScroll = function smoothScroll() {
  var scroll = function scroll(targetEl, duration) {
    ...
    var targetsPosition = targets.getBoundingClientRect().top - 100;
...
function fixedNav() {
  var stickyNav = document.querySelector('.delivery-nav');
  var stickyNavBtn = document.querySelectorAll('.delivery-nav__item-link');

  if (stickyNav) {
    var wrapper = document.querySelector('.delivery__wrapper').scrollHeight;
    document.addEventListener('scroll', function (e) {
      if (window.scrollY >= 150) {
...
function burgerMenu() {
  ...
  var menuMobile = document.querySelector('.header__top');
  ...
  var menuBtn = document.querySelectorAll('.menu__btn');
  var menuRight = document.querySelectorAll('.menu__right');
  var menuItem = document.querySelectorAll('.menu__list-item');
  menuBtn.forEach(function (el) {
    el.addEventListener('click', function (e) {
      var currentBtn = e.currentTarget;
      var rightMenu = currentBtn.closest('.menu__list-item').querySelector('.menu__right');
      var currentLi = currentBtn.closest('.menu__list-item');
  ...
  var menuBtnDown = document.querySelectorAll('.menu__dropdown-btn');
  var menuDropDown = document.querySelectorAll('.dropdown-list');
  var menuDropItem = document.querySelectorAll('.menu__dropdown-item');
  menuBtnDown.forEach(function (el) {
    el.addEventListener('click', function (e) {
      var currentBtn = e.currentTarget;
      var currentDrop = currentBtn.closest('.menu__dropdown-item').querySelector('.dropdown-list');
      var currentLi = currentBtn.closest('.menu__dropdown-item');
      menuBtnDown.forEach(function (el) {
        if (el !== currentBtn) {
          el.classList.remove('active');
        }
      ...
      menuDropItem.forEach(function (el) {
        if (el !== currentLi) {
          el.classList.remove('active');
        }
      });
...
function cabinetNav() {
  var cabinetBtn = document.querySelectorAll('.cabinet__btn');
  var cabinetItem = document.querySelectorAll('.cabinet__item');
...
function showPass() {
  var inputShow = document.querySelectorAll(".form__btn-eye");
  inputShow.forEach(function (item) {
    item.addEventListener("click", function () {
      var field = this.parentNode.querySelector(".js-show");
      field.type = field.type == "password" ? "text" : "password";
    });
  });
}

showPass(); // function showTabe() {
//   const showTable = document.querySelectorAll('.js-show-table');
//   const tableItem = document.querySelector('.history__item');
//     showTable.forEach(function(item) {
//       item.addEventListener("click", () => {
//         tableItem.classList.add('active');
//           tableItem.forEach(function() {
...
var btnTable = document.querySelectorAll('.js-show-table');
btnTable.forEach(function (el) {
  el.addEventListener('click', function (e) {
    var self = e.currentTarget;
    var table = self.closest('.history__item').querySelector('.history__table');
